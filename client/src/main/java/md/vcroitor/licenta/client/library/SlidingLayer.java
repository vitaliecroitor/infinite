package md.vcroitor.licenta.client.library;
...
import md.vcroitor.licenta.client.helper.CommonUtils;
...
public class SlidingLayer extends FrameLayout {
    ...
    /**
     * Sets the listener to be invoked after a switch change {@link md.vcroitor.licenta.client.library.SlidingLayer.OnInteractListener}.
     *
