...
/**
 * User: Vitalie Croitor Date: 5/4/13 Time: 4:44 PM
 */
public class AsyncHttpRequest extends AsyncTask<String, Void, String> {
	...
	protected String doInBackground(String... params) {
		...
		try {
			...
			final ResponseEntity<String> httpResponse = restTemplate.exchange(
					url, HttpMethod.valueOf(method), requestEntity,
					String.class);
